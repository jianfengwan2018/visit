...
void
FilledBoundaryAttributes::SetCustomLegendTitleEnabled(bool customLegendTitleEnabled_)
{
...
void
FilledBoundaryAttributes::SetCustomLegendTitle(const std::string &customLegendTitle_)
{
...
bool
FilledBoundaryAttributes::GetCustomLegendTitleEnabled() const
{
    return customLegendTitleEnabled;
}

const std::string &
FilledBoundaryAttributes::GetCustomLegendTitle() const
{
    return customLegendTitle;
}

std::string &
FilledBoundaryAttributes::GetCustomLegendTitle()
{
    return customLegendTitle;
}
...
void
FilledBoundaryAttributes::SelectCustomLegendTitle()
{
    Select(ID_customLegendTitle, (void *)&customLegendTitle);
}
