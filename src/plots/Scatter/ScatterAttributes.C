...
void
ScatterAttributes::SetCustomLegendTitleEnabled(bool customLegendTitleEnabled_)
{
...
void
ScatterAttributes::SetCustomLegendTitle(const std::string &customLegendTitle_)
{
...
bool
ScatterAttributes::GetCustomLegendTitleEnabled() const
{
    return customLegendTitleEnabled;
}

const std::string &
ScatterAttributes::GetCustomLegendTitle() const
{
    return customLegendTitle;
}

std::string &
ScatterAttributes::GetCustomLegendTitle()
{
    return customLegendTitle;
}
...
void
ScatterAttributes::SelectCustomLegendTitle()
{
    Select(ID_customLegendTitle, (void *)&customLegendTitle);
}
